...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .moves = {MOVE_SHADOW_SNEAK, MOVE_SHADOW_BALL, MOVE_BRICK_BREAK, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 48,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER, MOVE_BITE, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_HIDDEN_POWER, MOVE_EARTHQUAKE, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 48,
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_HIDDEN_POWER, MOVE_FIRE_PUNCH, MOVE_THUNDERPUNCH}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .moves = {MOVE_SUPERPOWER, MOVE_HIDDEN_POWER, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HEAT_WAVE, MOVE_CRUNCH, MOVE_HIDDEN_POWER, MOVE_PURSUIT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HYPNOSIS, MOVE_DESTINY_BOND, MOVE_THUNDERBOLT, MOVE_ICE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 49,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_GRASSWHISTLE, MOVE_GIGA_DRAIN, MOVE_ICE_BEAM, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .moves = {MOVE_HYPNOSIS, MOVE_AIR_SLASH, MOVE_HEAT_WAVE, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_THUNDER_WAVE, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_FIRE_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 51,
    .species = SPECIES_SABLEYE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_RECOVER, MOVE_SHADOW_BALL, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 51,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_BRICK_BREAK, MOVE_REST, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_WEATHER_BALL, MOVE_ICE_BEAM, MOVE_SPIKES, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 50,
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HYPER_VOICE, MOVE_WATER_SPOUT, MOVE_SELF_DESTRUCT, MOVE_AMNESIA}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_COUNTER, MOVE_ICE_BEAM, MOVE_THUNDER, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_ICE_BEAM, MOVE_DRILL_RUN, MOVE_HIDDEN_POWER, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_EARTHQUAKE, MOVE_YAWN, MOVE_MUDDY_WATER, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_ICE_SHARD, MOVE_THUNDER, MOVE_ICE_BEAM, MOVE_HYDRO_PUMP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .moves = {MOVE_DRACO_METEOR, MOVE_LUSTER_PURGE, MOVE_HIDDEN_POWER, MOVE_RECOVER}
    },
    {
    .iv = 255,
    .lvl = 54,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DRAGON_DANCE, MOVE_ANCIENT_POWER, MOVE_EARTHQUAKE, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DRACO_METEOR, MOVE_AIR_SLASH, MOVE_EARTHQUAKE, MOVE_FLAMETHROWER}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HIDDEN_POWER, MOVE_OCTAZOOKA, MOVE_DRACO_METEOR, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DRAGON_DANCE, MOVE_EARTHQUAKE, MOVE_EXTREME_SPEED, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 55,
    ...
    .heldItem = ITEM_SOUL_DEW,
    .moves = {MOVE_CALM_MIND, MOVE_DRAGON_CLAW, MOVE_HIDDEN_POWER, MOVE_RECOVER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SELF_DESTRUCT, MOVE_ATTRACT, MOVE_SEISMIC_TOSS, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 255,
    .lvl = 14,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_AERIAL_ACE, MOVE_BRICK_BREAK, MOVE_X_SCISSOR, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 14,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_THROW, MOVE_SECRET_POWER, MOVE_YAWN, MOVE_WATER_PULSE}
    },
    {
    .iv = 255,
    .lvl = 14,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TOXIC, MOVE_CURSE, MOVE_ROLLOUT, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 15,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HYPNOSIS, MOVE_MOONLIGHT, MOVE_CONFUSION, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLEEP_TALK, MOVE_ROLLING_KICK, MOVE_ROCK_SLIDE, MOVE_SECRET_POWER}
    },
    {
    .iv = 255,
    .lvl = 17,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HYPNOSIS, MOVE_SURF, MOVE_ICE_PUNCH, MOVE_BRICK_BREAK}
    },
    {
    .iv = 255,
    .lvl = 19,
    .species = SPECIES_HARIYAMA,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FORCE_PALM, MOVE_SHADOW_PUNCH, MOVE_ROCK_SLIDE, MOVE_FAKE_OUT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_JOLTEON,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_THUNDER_WAVE, MOVE_HIDDEN_POWER, MOVE_THUNDERBOLT, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 20,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_THUNDER_WAVE, MOVE_ICE_BEAM, MOVE_SURF, MOVE_THUNDERBOLT}
    },
    {
    .iv = 255,
    .lvl = 22,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_THUNDER_WAVE, MOVE_FIRE_PUNCH, MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 24,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT, MOVE_SURF, MOVE_BODY_SLAM}
    },
    {
    .iv = 255,
    .lvl = 22,
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HIDDEN_POWER, MOVE_OVERHEAT, MOVE_SOLAR_BEAM, MOVE_HYPNOSIS}
    },
    {
    .iv = 255,
    .lvl = 27,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HEAT_WAVE, MOVE_EARTHQUAKE, MOVE_SOLAR_BEAM, MOVE_DRAGON_CLAW}
    },
    {
    .iv = 255,
    .lvl = 28,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_BLAZE_KICK, MOVE_SKY_UPPERCUT, MOVE_THUNDER_PUNCH, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 255,
    .lvl = 28,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_WILD_CHARGE, MOVE_HEAT_WAVE, MOVE_SOLAR_BEAM, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SOLAR_BEAM, MOVE_HEAT_WAVE, MOVE_EARTHQUAKE, MOVE_WILD_CHARGE}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FLAMETHROWER, MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HYPER_BEAM, MOVE_CRUSH_CLAW, MOVE_SHADOW_BALL, MOVE_SUPERPOWER}
    },
    {
    .iv = 255,
    .lvl = 27,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_SKILL_SWAP, MOVE_SING}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_CRUSH_CLAW, MOVE_SHADOW_BALL, MOVE_SUPERPOWER}
    },
    {
    .iv = 255,
    .lvl = 31,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_SKY_ATTACK, MOVE_STEEL_WING, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 31,
    .species = SPECIES_TAUROS,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_BODY_SLAM, MOVE_IRON_TAIL, MOVE_QUICK_ATTACK, MOVE_EARTH_POWER}
    },
    {
    .iv = 255,
    .lvl = 31,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_CURSE, MOVE_SNORE, MOVE_REST, MOVE_STOCKPILE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HIDDEN_POWER, MOVE_ANCIENT_POWER, MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 29,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SKY_ATTACK, MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER, MOVE_RETURN}
    },
    {
    .iv = 255,
    .lvl = 30,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SKY_ATTACK, MOVE_POISON_FANG, MOVE_GIGA_DRAIN, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 31,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_ICE_BEAM, MOVE_SKY_ATTACK, MOVE_ICE_SHARD, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 33,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_OVERHEAT, MOVE_SKY_ATTACK, MOVE_HIDDEN_POWER, MOVE_STEEL_WING}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_LATIAS,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DRAGON_CLAW, MOVE_MIST_BALL, MOVE_HIDDEN_POWER, MOVE_WATERFALL}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_LATIOS,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_DRAGON_CLAW, MOVE_LUSTER_PURGE, MOVE_HIDDEN_POWER, MOVE_THUNDERBOLT}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_FIRE_PUNCH, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 42,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_BRICK_BREAK, MOVE_HIDDEN_POWER, MOVE_SHADOW_BALL}
    },
    {
    .iv = 255,
    .lvl = 42,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_METEOR_MASH, MOVE_SIGNAL_BEAM, MOVE_FIRE_PUNCH, MOVE_ANCIENT_POWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_OCTAZOOKA, MOVE_ICE_BEAM, MOVE_DRACO_METEOR, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_LAPRAS,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_THUNDER, MOVE_ICE_BEAM, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_CASTFORM,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_WEATHER_BALL, MOVE_ICE_BEAM, MOVE_THUNDER, MOVE_HIDDEN_POWER}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_GIGA_DRAIN, MOVE_THUNDER_PUNCH, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SING, MOVE_ICE_BEAM, MOVE_HYDRO_PUMP, MOVE_HIDDEN_POWER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_HYDRO_PUMP, MOVE_THUNDERBOLT, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_JIRACHI,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_METEOR_MASH, MOVE_EXTRASENSORY, MOVE_FIRE_PUNCH, MOVE_THUNDERBOLT}
    },
    {
    .iv = 255,
    .lvl = 56,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_BRICK_BREAK, MOVE_FLAMETHROWER}
    },
    {
    .iv = 255,
    .lvl = 56,
    .species = SPECIES_AERODACTYL,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_SKY_ATTACK, MOVE_EARTHQUAKE, MOVE_FLAMETHROWER, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 255,
    .lvl = 58,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_PSYCHO_BOOST, MOVE_SUPERPOWER, MOVE_SHADOW_BALL, MOVE_FIRE_PUNCH}
    }
};
